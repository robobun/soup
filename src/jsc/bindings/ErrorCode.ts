...
const errors: ErrorCodeMapping = [
  ...
  ["ERR_JWT_INVALID", Error, "JWTError"],
  ["ERR_JWT_SIGNATURE_VERIFICATION_FAILED", Error, "JWTError"],
  ["ERR_JWT_ALGORITHM_NOT_ALLOWED", Error, "JWTError"],
  ["ERR_JWT_EXPIRED", Error, "JWTError"],
  ["ERR_JWT_NOT_ACTIVE", Error, "JWTError"],
  ["ERR_JWT_CLAIM_VALIDATION_FAILED", Error, "JWTError"],
  ["ERR_JWT_INVALID_KEY", TypeError],
