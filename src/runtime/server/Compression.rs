...
pub(crate) const BROTLI_QUALITY: i32 = 4;
pub(crate) const DEFLATE_LEVEL: i32 = 6;
...
pub(crate) struct Accepted([u16; Encoding::COUNT]);

impl Accepted {
    pub(crate) fn from_request(req: &AnyRequest) -> Accepted {
    ...
    pub(crate) fn parse(value: &[u8]) -> Accepted {
...
pub(crate) fn for_request(config: Option<Config>, req: &AnyRequest) -> Option<Encoding> {
...
impl Config {
    ...
    pub(crate) fn encodings(&self) -> &[Encoding] {
    ...
    pub(crate) fn select(&self, accepted: Accepted) -> Option<Encoding> {
    ...
    pub(crate) fn from_js(global: &JSGlobalObject, value: JSValue) -> JsResult<Option<Config>> {
...
pub(crate) fn is_compressible_type(content_type: &[u8]) -> bool {
...
pub(crate) fn forbids_transform(cache_control: &[u8]) -> bool {
...
pub(crate) fn vary_with_accept_encoding(existing: Option<&[u8]>) -> Option<Vec<u8>> {
...
pub(crate) fn weak_etag(etag: &[u8]) -> Option<Vec<u8>> {
...
pub(crate) fn encode(encoding: Encoding, input: &[u8]) -> Option<Vec<u8>> {
