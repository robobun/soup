...
impl LastFailed {
    ...
    pub(crate) fn select(&mut self, files: &mut [Interned]) -> usize {
        let mut write = 0;
    ...
    pub(crate) fn record(&mut self, abs_path: &[u8], failed: bool) {
    ...
    pub(crate) fn begin_file(&mut self, abs_path: &[u8]) {
