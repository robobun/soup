...
The `HTTP_PROXY` and `HTTPS_PROXY` environment variables accept the same URLs. See the [proxy guide](/guides/http/proxy#socks5-proxies) for the error codes a SOCKS5 proxy can produce.
