...
<ParamField path="--global-name" type="string">
  With <code>--format=iife</code>, assign the exports of the entry point to this global variable, or to a property path
  such as <code>app.plugins.myLib</code>
</ParamField>
